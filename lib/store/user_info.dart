...
class UserInfo extends GetxController {
  ...
  Future<String> get getToken async {
    ...
    final String? encodedToken = await LocalStorage.getString(
      AppKeys.tokenName,
    );
  ...
  Future<void> initialize() async {
    ...
    if (token.isNotEmpty) {
      ...
      /// 从本地存储加载用户数据
      final String? userInfoJson = await LocalStorage.getString(
        AppKeys.userKey,
      );
  ...
  Rx<NewUserModel> newUserModel = NewUserModel().obs;
