...
class ImageConfig {
  ...
  static String dialogTitleSide =
      "${AppConfig.instance.getImgUrl}/Rscsgo/images/web/common/comDialog_title_icon.png";
  ...
  /// 错误
  static String error =
      "${AppConfig.instance.getImgUrl}/AdObject/common/error.png";
  ...
  /// 邀请好友主界面背景
  static String inviteBg =
      "${AppConfig.instance.getImgUrl}/AdObject/invite/invite_bg.png";
