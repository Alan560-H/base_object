                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(spacing: 10.w,
                                  children: [
                                    Avatar(headImage: controller.userInfo.userModel.headImage,size: 20.r,),
                                    Column(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                     ...
                     child: InkWell(
                       ...
                       child: Column(
                         children: [
                           ...
                           Text("复制链接",style: TextStyle(fontWeight: FontWeight.bold),)
                         ],
                       ),
                     ),
                   )
                  ...
                  CuButton(text: "取消",width:Get.width,fontSize:TextConfig.textSize_20,textColor: TextConfig.primary, onPressed:()=>Get.back())
              ],
            ),
          )]),
        ),
