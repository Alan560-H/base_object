        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              controller.isPasswordLogin.value
                  ? Border(
                bottom: BorderSide(color: TextConfig.primary, width: 2.sp),
              )
                  : null,
            ),
            child: CuButton(
              width: 120.w,
              textColor:
              controller.isPasswordLogin.value ? Colors.white : Utils.fromHex("#6d6d6d"),
          ...
          Container(
            decoration: BoxDecoration(
              ...
              !controller.isPasswordLogin.value
                  ? Border(
                bottom: BorderSide(color: TextConfig.primary, width: 2),
              )
                  : null,
            ),
            child: CuButton(
        ...
        Expanded(
          child: InkWell(
            ...
            child: RichText(
              text: TextSpan(
                children: [
                   TextSpan(text: '我已年满18岁，登录即同意',style: TextStyle(color: TextConfig.black333)),
                  TextSpan(
                    text: '用户协议',
          ...
          children: [
            ...
            Positioned(
              ...
              child: CuButton(
                width: 120.w,
                height: 50.h,
                text: controller.countdown.value > 0 ? '${ controller.countdown.value}秒后重发' : '发送验证码',
                onPressed:  controller.countdown.value == 0 ? controller.startCountdown : null,
              ),
            ),
          ],
        ),
  ...
  Widget _buildDynamicForm() {
    return Obx(()=>Container(
      ...
      child: Column(
        spacing: 20.h,
        children: [
          ...(controller.isPasswordLogin.value ? _buildPasswordForm() : _buildCodeLoginForm()),
          checkedXieyi(),
