...
class UserView extends GetView<UserController> {
  ...
  Widget getCom({String value="",String title=""}){
    return Column(
      ...
      children: [
        Text(value,style: TextStyle(fontSize: TextConfig.textSize_20,color: Colors.white),),
        Text(title,style: TextStyle(fontSize: TextConfig.textSize_14,color: Colors.white),),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(()=>
         Container(
           padding: EdgeInsets.only(left: 10.w,right: 10.w,top: Get.mediaQuery.padding.top+10.h),
