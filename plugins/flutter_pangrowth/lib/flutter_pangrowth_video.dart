...
class PangrowthVideo {
  ...
  ///短剧聚合页
  static Widget drawHomeView({required double viewWidth, required double viewHeight}) {
    return DrawHomeView(viewWidth: viewWidth, viewHeight: viewHeight);
  }

  static Widget videoSingleCardView({required double viewWidth, required double viewHeight}) {
